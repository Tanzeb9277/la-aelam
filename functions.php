...
function site_files() {
  ...
  wp_enqueue_style('site_extra_styles', get_theme_file_uri('/build/style-index.css'));
  wp_enqueue_style('site_extra_extra_styles', get_theme_file_uri('/build/index.css'));
